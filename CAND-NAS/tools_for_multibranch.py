...
def to_dense_batch(x, max_num_nodes=None, batch=None, fill_value=0):
    ...
    hidden_zeros = torch.sum(torch.abs(out.view(batch_size * max_num_nodes,-1)),-1)
    #print(out.size())
    mask[hidden_zeros==0] = 1
...
def to_dense_adj(edge_index, max_num_nodes=None, batch=None, edge_attr=None):
    ...
    edge_index_one = all_edges.t().view(2,-1)
