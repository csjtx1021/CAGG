...
from R_EA_200     import train_and_eval, random_architecture_func
...
def main(xargs, nas_bench):
  ...
  while total_time_cost < xargs.time_budget:
    arch = random_arch()
    accuracy, cost_time = train_and_eval(arch, nas_bench, extra_info, dataname, rand_seed=args.rand_seed)
