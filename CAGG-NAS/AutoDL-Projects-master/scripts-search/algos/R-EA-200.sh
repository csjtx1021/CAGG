...
#benchmark_file=${data_dir}/NAS-Bench-201-v1_1-096897.pth

save_dir=./output/search-cell-${space}/R_EA-200-${dataset}-SS${sample_size}

OMP_NUM_THREADS=4 python ./exps/algos/R_EA_200.py \
